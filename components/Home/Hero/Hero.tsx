...
const Hero = () => {
  return (
    <div className='relative w-full h-[120vh] sm:h-[100vh] mt-10'>
        {/* overlay */}
        <div className='absolute top-0 left-0 w-full h-full bg-gray-700 opacity-70'></div>
        <video src="/images/hero1.mp4" autoPlay muted loop preload='metadata'
         className='w-full h-full object-cover'/>
        <div className='absolute z-[100] w-full h-full top-[50%]
                ...
                <div data-aos="fade-up">
                    <h1 className='text-[25px] mb-4 md:mb-0 text-center  
                      ...
                      <p className='md:text-base text-center text-lg text-white font-normal
                       [word-spacing"5px]'>Get the best prices on 2,00,000+ properties, worldwide</p>
                </div>
                {/* search box */}
                <SearchBox />
                <Link href='#' className='rounded px-14 md:px-28 -mt-4 py-2.5
                 overflow-hidden group bg-rose-600 relative hover:bg-gradient-to-r
                  hover:from-red-500 hover:to-red-400 text-white 
                   hover:ring-2 hover:ring-offset-2 hover:ring-red-400 transition-all
