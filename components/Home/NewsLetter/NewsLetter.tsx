  ...
  return (
    <div className='bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col'>
        ...
        <div className='w-full'>
            ...
            <button className='px-6 py-3.5 bg-blue-900 hover:bg-blue-950 mt-3 w-[95%] sm:w-[80%] md:w-[60%] 
            text-white lg:w-[40%] block mx-auto rounded-lg outline-none cursor-pointer'>Subscribe</button>
        </div>
    </div>
  )
}
